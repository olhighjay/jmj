...
export default function Home() {
  // Carousel images - using Supabase Storage (falls back to local if not configured)
  const carouselImages = [
    {
      src: getImageUrl('header/Daddy-hero-3.jpg'),
    ...
    {
      src: getImageUrl('header/Daddy-hero-2.jpg'),
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="bg-gray-200 h-48 flex items-center justify-center">
                <Image src={getImageUrl('general/IMG_7711.JPG')} alt="Area Commander" width={300} height={300} className="service-img" />
              </div>
              <div className="p-6">
